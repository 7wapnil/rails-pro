...
Devise.setup do |config|
  ...
  # config.secret_key = '473622df344298d145ebc3704d11c729e840e16c3ce6e379'
  ...
  # (the default algorithm), the cost increases exponentially with the
  # number of stretches (e.g. a value of 20 is already extremely
  # slow: approx. 60 seconds for 1 calculation).
  config.stretches = Rails.env.test? ? 1 : 11

  # Set up a pepper to generate the hashed password.
  # config.pepper = '025edd82f0aa88b45c441cd5c48bded97770aaa037ecacc223f'
