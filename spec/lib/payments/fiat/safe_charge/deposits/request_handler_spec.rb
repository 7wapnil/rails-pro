...
describe ::Payments::Fiat::SafeCharge::Deposits::RequestHandler do
  ...
  before do
    allow(::Payments::Fiat::SafeCharge::PaymentUrlValidator)
      .to receive(:call)
      .and_return(true)
  ...
  context 'accepts extra query' do
    context 'common params' do
      ...
      let(:is_native) do
        ::Payments::Fiat::SafeCharge::PaymentUrlValidator::BOOLEAN_OPTIONS
          .sample.to_s
      end
  ...
  context 'validation' do
    ...
    it 'is called with checksum' do
      expect(::Payments::Fiat::SafeCharge::PaymentUrlValidator)
        .to receive(:call)
