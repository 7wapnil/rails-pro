...
describe ::Payments::Fiat::SafeCharge::PaymentUrlValidator do
  subject do
  ...
  let(:item_quantity_1) do
    ::Payments::Fiat::SafeCharge::Deposits::RequestHandler::ITEM_QUANTITY
  end
  ...
  let(:query_params) do
    {
      ...
      version: ::Payments::Fiat::SafeCharge::Deposits::RequestHandler::
                 API_VERSION,
      ...
      isNative: 1,
      payment_method: ::Payments::Fiat::SafeCharge::Methods::CC_CARD,
