context 'Customers#show navigation' do
  ...
  it 'navigates to customers#show' do
    within 'ul.navigation' do
      click_link I18n.t('internal.navigation.customer.account')
  ...
  it 'navigates to customers#account_management' do
    within 'ul.navigation' do
      click_link I18n.t('internal.navigation.customer.account_management')
      expect(page)
  ...
  it 'navigates to customers#activity' do
    within 'ul.navigation' do
      click_link I18n.t('internal.navigation.customer.activity')
  ...
  it 'navigates to customers#bonuses' do
    within 'ul.navigation' do
      click_link I18n.t('internal.navigation.customer.bonuses')
  ...
  it 'navigates to customers#notes' do
    within 'ul.navigation' do
      click_link I18n.t('internal.navigation.customer.notes')
  ...
  it 'navigates to customers#documents' do
    within 'ul.navigation' do
      click_link I18n.t('internal.navigation.customer.documents')
  ...
  it 'navigates to customers#bets' do
    within 'ul.navigation' do
      click_link I18n.t('internal.navigation.customer.bets')
  ...
  it 'navigates to customers#betting_limits' do
    within 'ul.navigation' do
      click_link I18n.t('internal.navigation.customer.betting_limits')
  ...
  xit 'navigates to customers#deposit_limit' do
    within 'ul.navigation' do
      click_link I18n.t('internal.navigation.customer.deposit_limit')
  ...
  it 'navigates to customers#transactions' do
    within 'ul.navigation' do
      click_link I18n.t('internal.entities.transactions')
