...
module CustomersHelper
  ...
  def reset_password_link_data(customer)
    { data: { endpoint: reset_password_to_default_customer_path(customer),
              confirmation: t('internal.messages.reset_password_confirmation',
                              customer_name: customer.full_name),
              success_message: t('internal.messages.reset_password_success'),
              error_message: t('internal.messages.reset_password_error') } }
  end
