  ...
  module SafeCharge
    module Currency
      AVAILABLE_CURRENCY_LIST = {
        ...
        ::Payments::SafeCharge::Methods::APMGW_SOFORT => %w[EUR GBP].freeze,
        ::Payments::SafeCharge::Methods::APMGW_IDEAL => %w[
        ...
        ::Payments::SafeCharge::Methods::APMGW_QIWI => %w[EUR RUB USD].freeze
      }.freeze
    end
  end
end
