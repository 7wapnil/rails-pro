...
entry_currency_rule_ranges = {
  ...
  EntryKinds::SYSTEM_ADJUSTMENT => { min: -100_000_000, max: 100_000_000 },
  ...
  EntryKinds::MANUAL_BET_CANCEL => { min: -100_000_000, max: 100_000_000 },
  EntryKinds::MANUAL_BET_PLACEMENT => { min: -100_000_000, max: 0 },
